    ...
    def resolve_layer(self, graph_matcher, graph_helper):
        ...
        for sequence in sequences:
            ...
            for match in matches:
                ...
                anchors = np.reshape(anchors, expand_to_rank(list(anchors.shape), 3))
                anchors_shape = expand_to_rank(list(anchors.shape), 3)
                if len(anchors_shape) > 3:
                    anchors_shape = anchors_shape[-3:]
